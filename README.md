...
* [3. Networked Services and APIs](#3-networked-services-and-apis)
  ...
  * [3.4. Network level](#33-network-level)
...
* [6. REST applied in a modern API](#6-rest-applied-in-a-modern-api)
  * [6.1. Requirements from a modern REST API](#61-requirements-from-a-modern-rest-api)
    * [6.1.1. Sparse fields (collection/resource)](#611-sparse-fields-collection-resource)
    * [6.1.2. Associations on demand (collection/resource)](#612-associations-on-demand-collection-resource)
