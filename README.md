...
runtime, **it provides them on the side, only if requested**. (++ we have more than hypermedia)
...
from pure introspective MicroTypes is that part of their functionality the semantics of the client's request
